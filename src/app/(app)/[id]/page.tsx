  ...
  return (
    <div className='w-full container items-center grid gap-12 py-6 grid-cols-1 lg:grid-cols-2'>
      <div className='flex flex-col items-center w-full'>
        <div className='w-full h-[500px] group mb-4 overflow-hidden aspect-square'>
          {loading ? (
            ...
            <Image
              className='object-cover border group-hover:scale-105 transition-transform rounded-md aspect-square h-full w-full'
              src={imageSelected}
              alt={immobile?.code}
              width={900}
              height={900}
